  ...
  if (currentLevel <= maxLevel) {
    getDirectories(join(baseDir, relativeDir))
      ...
      .forEach(subDir => {
        const children = side(
          baseDir,
          { stripNumbers, maxLevel, navPrefix, skipEmptySidebar, filter },
              ...
              if(link.children) {
                if(typeof link.children[0] == 'string') childrenTitle = link.children[0];
                  ...
                  const getTitle = (children) => {
                    const f = Object.prototype.toString.call(children)
                    if (Object.prototype.toString.call(children) == '[object Array]' ) {
                      return getTitle(children[0])
                    } else if (typeof children === 'object') {
                      return getTitle(children.children)
                    }

                    return children
                  }
                  childrenTitle = getTitle(link)
                }
